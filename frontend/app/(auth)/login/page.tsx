...
export default function LoginPage() {
  return (
    <div className="w-full flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-2xl bg-white/70 dark:bg-zinc-950/60 backdrop-blur-2xl ring-1 ring-white/20 dark:ring-white/10 max-w-5xl mx-auto min-h-[600px]">
      ...
      <div className="w-full md:w-1/2 p-10 flex flex-col items-center justify-between bg-gradient-to-br from-white/60 to-white/30 dark:from-zinc-900/60 dark:to-zinc-900/30">
        <div className="flex flex-col items-center gap-4 mt-8">
          ...
          <h2 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 mt-4">Welcome Back!</h2>
        ...
        <div className="flex flex-col items-center gap-4 mt-12 mb-8">
          <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">New here? Create a new account</p>
      ...
      <div className="w-full md:w-1/2 p-10 flex flex-col justify-center bg-white dark:bg-zinc-950">
        <div className="max-w-md w-full mx-auto">
          <h2 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-white mb-8">Sign-In</h2>
          
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-1">
              <label className="text-sm font-medium text-zinc-700 dark:text-zinc-300">Enter DES PU Mail ID or Username</label>
              <input 
                type="text" 
            ...
            <div className="flex justify-end pt-1">
              <a href="#" className="text-sm font-semibold text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">Forgot Password?</a>
            </div>

            <button className="w-full rounded-xl bg-blue-600 px-6 py-3.5 font-semibold text-white shadow-lg shadow-blue-500/30 hover:bg-blue-500 transition-all duration-200 mt-2 flex items-center justify-center gap-2">
            ...
            <button type="button" className="w-full rounded-xl bg-white dark:bg-zinc-900 px-6 py-3.5 font-semibold text-zinc-900 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-300 dark:ring-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all duration-200 flex justify-center items-center gap-3">
